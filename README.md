...
|  **A little louder please.** | Increments the audio output volume up. |
|  **A little quieter please.** | Decrements the audio output volume down. |
|  **A little softer please.** | Decrements the audio output volume down. |

> **NOTE:** This Markdown table was generated by [MarkdownTableMaker for Google Sheets][mtm].

## Siri Screen Brigtness Settings Commands
