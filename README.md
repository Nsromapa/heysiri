...
|  **Freddy is my chef.** | Prompts the user for confirmation before adding the label "chef" to Eddy's contact information. |
|  **My nickname is Freddy.** | Prompts the user for confirmation before changing the personal name that Siri uses in social graphs and discourse. |
