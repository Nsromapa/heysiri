...
+ Siri commands are tested in iOS 13 and iPadOS 13.
...
| :--- | :--- |
|  **Show my wallet.** | Opens Wallet App and displays cards or transit passes. |
...
|  **Siri Command** | Response |
| :--- | :--- |
|  **Abby is my sister.** | Adds the label "sister" to Abby's contact information. |
|  **Bobby is my brother.** | Adds the label "brother" to Bobby's contact information. |
|  **Cammy is my lawyer.** | Adds the label "lawyer" to Cammy's contact information. |
|  **Danny is my plumber.** | Adds the label "plumber" to Danny's contact information. |
...
## Reference and Trivia Siri Commands
