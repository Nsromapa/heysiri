...
|  **Siri Command** | Response |
| :--- | :--- |
|  **Solve 5 equals 4x plus 3y AND 8 equals 3x plus 5y.** | Returns a solution for the two equations. May show graph. |
|  **Solve 0 equals x squared plus 2x minus 5.** | Returns the roots for the quadratic equation. May show graph. |
