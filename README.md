...
|  **Siri Command** | Response |
| :--- | :--- |
|  **Add a new event.** | Prompts users for date and time details about the new event. |
|  **Add a conference call to my calendar at 9 AM on Thursday.** | Adds new event labeled "conference call" at 9AM on Thursday. |
|  **Add a training course to my calendar at 2 PM tomorrow.** | Adds new event labeled "training course" at 2PM tomorrow. |
