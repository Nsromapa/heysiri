...
## Siri Algebra Commands

|  **Siri Command** | Response |
| :--- | :--- |
|  **Solve 5 equals 4x plus 3y AND<br/> 8 equals 3x plus 5y.** | Returns a solution for the two equations. May show graph. |
|  **Solve x squared plus 6x plus 9 equals zero.** | Returns the roots for the quadratic equation. May show graph. |
